...
const spreadsheetID = "1tATHcYd8CO3OSGAbYAT_sX_a7mpMP4QbCHk7KaM6xGE";
...
d3.json("https://spreadsheets.google.com/feeds/list/1tATHcYd8CO3OSGAbYAT_sX_a7mpMP4QbCHk7KaM6xGE/od6/public/values?alt=json", type, (err, data) => {
  data ? console.log("noice") : console.log("blyat");
